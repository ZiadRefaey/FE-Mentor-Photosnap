function InstagramIcon({ color1, color2, color3 }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20">
      <defs>
        <linearGradient id="InstagramIcon" x1="0%" x2="50%" y1="100%" y2="0%">
          <stop offset="0%" stopColor={color1} />
          <stop offset="51.945%" stopColor={color3} />
          <stop offset="100%" stopColor={color2} />
        </linearGradient>
      </defs>
      <path
        fill="url(#InstagramIcon)"
